...
class AttributeDataProcessorMOT:
    def __init__(self):
    ...
    def get_attribute_dict(self):
        attribute_dict = {
            ...
            'Date': {
                'column_positive': ['DataCollection_StartTime','date_bookingdatetime','MRK_DateTime'],
                'description_positive': ['time','start'],
                'column_negative': [],
                'description_negative': []
            },
            'Cell no': {
                'column_positive': ['Cell_1'],
                'description_positive': [],
                'column_negative': [],
                'description_negative': []
            },
            ...
            'Product Code': {
                'column_positive': ['ProductNameReport','Product_Code'],
                'description_positive': [],
                'column_negative': ['ProductNameReport_Recode - DO NOT USE'],
                'description_negative': []
            },
            'Overall_LIK': {
                'column_positive': ['LIKING_9_SCALESYMDES_PRODUCT_OVERALL'],
                'description_positive': [],
                'column_negative': ['sip','time'],
                'description_negative': ['As entered']
            },
            'Overall Flavor_LIK': {
            ...
            'Sweetness_INT': {
                ...
                'column_negative': [],
                'description_negative': ['too sweet', 'not sweet enough','As entered']
            },
            ...
            'Aftertaste Detection_AT': {
                ...
                'description_positive': ["="],
                'column_negative': [],
                'description_negative': ['As entered','Reasons']
            },
            ...
            'Purchase Intent_PI': {
                'column_positive': ['Purchase Intent', 'Purchase', 'buy','pi','FUTUREINTENT'],
                'description_positive': [],
                'column_negative': [],
                'description_negative': ['As entered']
            },
